...
def process_questions(cfg, mode):
    ...
    print('Number of unk answers not in vocab: {}'.format(unk_count))
...
if __name__ == '__main__':
    ...
    if args.mode == 'test':
        cfg.dataset.annotation_file = '/AvaStore/DataSets/visual_qa/datasets/gqa/annotations/submission_all_questions.json'
