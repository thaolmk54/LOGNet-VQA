...
__C.train.lr = 0.0001
__C.train.schedule_method = 'warm_up' # 'batch_decay'
__C.train.gradual_warmup_steps = [1.0 * __C.train.lr, 1.0 * __C.train.lr, 2.0 * __C.train.lr, 2.0 * __C.train.lr]
__C.train.epoch_decay_start = 5
__C.train.lr_decay_step = 2
__C.train.lr_decay_rate = 0.25
...
__C.dataset.annotation_file = '/AvaStore/DataSets/visual_qa/datasets/gqa/annotations/{}_balanced_questions.json'
__C.dataset.data_dir = ''
__C.dataset.img_info = 'gqa_objects_merged_info.json'
__C.dataset.train_object_feature = 'gqa_objects.h5'
__C.dataset.train_spatial_feature = 'gqa_spatial.h5'
__C.dataset.val_object_feature = 'gqa_objects.h5'
__C.dataset.val_spatial_feature = 'gqa_spatial.h5'
__C.dataset.test_object_feature = 'gqa_objects.h5'
__C.dataset.test_spatial_feature = 'gqa_spatial.h5'
__C.dataset.vocab_json = 'gqa_vocab.json'
__C.dataset.train_question = 'gqa_train_questions.pt'
__C.dataset.val_question = 'gqa_val_questions.pt'
__C.dataset.test_question = 'gqa_test_questions.pt'
