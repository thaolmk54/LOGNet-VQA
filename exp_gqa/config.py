...
__C.dataset.train_feature = 'gqa_objects.h5'
__C.dataset.val_feature = 'gqa_objects.h5'
__C.dataset.test_feature = 'gqa_objects.h5'
__C.dataset.vocab_json = 'clevr_vocab.json'
__C.dataset.train_question = 'clevr_train_questions.pt'
__C.dataset.val_question = 'clevr_val_questions.pt'
__C.dataset.test_question = 'clevr_test_questions.pt'
