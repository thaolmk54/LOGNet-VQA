...
__C.dataset.annotation_file = '/ceph-g/lethao/datasets/clevr/CLEVR_v1/data/CLEVR_{}_questions.json'
...
__C.preprocess.glove_pt = '/ceph-g/lethao/datasets/glove/glove.840.300d.pkl'
