...
def train(cfg):
    ...
    train_loader = CLEVRHumanDataLoader(**train_loader_kwargs)
...
def main():
    ...
    parser.add_argument('--cfg', dest='cfg_file', help='optional config file', default='configs/clevr_human.yml', type=str)
